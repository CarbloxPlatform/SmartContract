...
// Carblox crowdsale contract

contract CarbloxCrowdsale is Ownable {
    ...
    uint256 public constant START = 1515596400; // Wed, 10 Jan 2018 15:00
    uint256 public constant DAYS = 30;
  
    uint256 public constant initialTokens = 68000000 * 10**3;
    ...
    function CarbloxCrowdsale(address _tokenAddr) public {
